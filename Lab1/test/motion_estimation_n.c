...
#define ACCESS_FILE "acessos.log"
...
/**************************************************************************/
unsigned char frame_memory_read(int frame, unsigned char *frame_memory, int relative_address, int flag)
{
...
/*                      trace-file.                                       */
/**************************************************************************/
unsigned char frame_memory_write(int frame, unsigned char *frame_memory, int relative_address,unsigned char pixel, int flag)
{
    int offset, absolute_address;
